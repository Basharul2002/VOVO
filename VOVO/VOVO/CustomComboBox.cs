...
namespace VOVO
{
    ...
    class CustomComboBox : UserControl
    {
        ...
        private Cursor customCursor = Cursors.IBeam; // IBeam cursor
        private Color customCursorColor = Color.Black; // Default cursor color
        ...
        public CustomComboBox()
        {
            ...
            // Set the cursor type to IBeam
            cmbList.Cursor = Cursors.IBeam;
        ...
        private void SetCursorColor(Color color)
        {
            ...
            // Create a cursor from the bitmap and set it as the current cursor
        ...
        protected override void OnMouseEnter(EventArgs e)
        {
            ...
            SetCursorColor(customCursorColor);
        }
        ...
        protected override void OnMouseLeave(EventArgs e)
        {
            ...
            // Restore the cursor type and color
            Cursor = customCursor;
            Cursor.Current = new Cursor(Cursor.Current.Handle);
            SetCursorColor(customCursorColor);
        }
        ...
        {
            get { return customCursorColor; }
            set { customCursorColor = value; }
        }
